...
<body>
    <div class="bg-img">
        <div class="wrapper">
            ...
            <header>Buyer registration Form </header>
            <form action="bregister.php" method="POST" class="form">
                <div class="inputfield">
                    <label class="label" for="ac" style="color:white" ;>Username:</label>
                    <input type="text" placeholder="username" name="username" required id="username">
                </div>
                <div class="inputfield">
                    <label class="label" for="fname" style="color:white" ;>OrganizationName:</label>
                    <input type="text" placeholder="OrganizationName" name="orgName">
                </div>
                <div class="inputfield">
                    <label class="label" for="lname" style="color:white" ;>OwnerName:</label>
                    <input type="text" placeholder="OwnerName" name="oName" required>
                </div>
                <div class="inputfield">
                    <label class="label" style="color:white">Organization Type</label>
                    <div class="custom_select">
                        <select required name="orgType">
                ...
                <div class="inputfield">
                    <button type="submit" class="btn" name="reg_user"
                        onclick="return validate_buyer()">Register</button>
                </div>
            </form>
        </div>
    </div>
